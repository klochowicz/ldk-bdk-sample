...
use lightning_invoice::payment::{self};
...
type NetGraph = NetworkGraph<Arc<FilesystemLogger>>;
...
async fn start_ldk() {
    ...
    let lightning_wallet = Arc::new(LightningWallet::new(Box::new(blockchain), bdk_wallet));
